  ...
  <div className="container">
    <div className="row rellati">
      ...
      <div id="latest_product_slider" className="owl-carousel testimonial-carousel-main rounded_pro">
        ...
        <div className="item">
          <div className="lp_round"><a href="#"><img src="images/icon29.png" alt="" /></a></div>
          <a href="#">Product name show here</a>
          <p>Rs.40.00 </p>
          <a href="#" className="inqq">Call For Enquiry</a>
        </div>
        <div className="item">
          <div className="lp_round"><a href="#"><img src="images/icon28.jpg" alt="" /></a></div>
          <a href="#">Product name show here</a>
          <p>Rs.40.00 </p>
          <a href="#" className="inqq">Call For Enquiry</a>
        </div>
        <div className="item">
          <div className="lp_round"><a href="#"><img src="images/icon27.jpg" alt="" /></a></div>
          <a href="#">Product name show here</a>
          <p>Rs.40.00 </p>
          <a href="#" className="inqq">Call For Enquiry</a>
        </div>
